 ...
 */
package mj.extraction.tika.parser.html;
...
class XHTMLDowngradeHandler extends ContentHandlerDecorator {
    ...
    public void startElement(
        ...
        for (int i = 0; i < atts.getLength(); i++) {
            ...
            if (XMLConstants.XML_NS_URI.equals(auri)
        ...
        super.startElement(XMLConstants.XML_NS_URI, upper, upper, attributes);
    }
    ...
    public void endElement(String uri, String localName, String name)
            throws SAXException {
        String upper = localName.toUpperCase(Locale.ENGLISH);
        super.endElement(XMLConstants.XML_NS_URI, upper, upper);
    }
