package mj.ocraptor.file_handler.executer;
...
public class CommandExecutor implements Runnable {
   ...
   */
  public void run() {
    Thread.currentThread().setName(Config.APP_NAME + "External command executor");
    if (command == null) {
  ...
  private class ProcessStandardOutput extends Thread {
    public void run() {
    Thread.currentThread().setName(Config.APP_NAME + "External command executor - Stdout");
      try {
  ...
  private class ProcessErrorOutput extends Thread {
    public void run() {
    Thread.currentThread().setName(Config.APP_NAME + "External command executor - Stderr");
      try {
