...
public class MessageDialog extends GUITemplate {
  ...
  void closeApplicationButtonClicked(ActionEvent event) {
    this.g.exitApplication();
  }

  @FXML
  void copyButtonClicked(ActionEvent event) {
    this.executeWorker(clipboardWorker());
    copyButton.setText(g.getText("MESSAGE_DIALOG.CONTENT_COPIED"));
      ...
      protected Object call() throws Exception {
        ...
        if (!plainText.toString().trim().isEmpty()) {
          Platform.runLater(new Runnable() {
            @Override
            public void run() {
              Thread.currentThread().setName(Config.APP_NAME + "JavaFX: Clipboard button clicked");
        ...
        Platform.runLater(new Runnable() {
          ...
          public void run() {
            ...
            copyButton.setText(g.getText("MESSAGE_DIALOG.COPY_TO_CLIPBOARD"));
  ...
  protected void initLabels() {
    closeWindowButton.setText(g.getText("MESSAGE_DIALOG.CLOSE"));
    closeApplicationButton.setText(g.getText("MESSAGE_DIALOG.SHUTDOWN"));
    copyButton.setText(g.getText("MESSAGE_DIALOG.COPY_TO_CLIPBOARD"));
    helpButton.setText(g.getText("HELP"));
  }
