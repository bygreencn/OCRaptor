...
public class CommandLineInterpreter {
  ...
  private static final String //
      ...
      VERBOSE_OPTION = "verbose", VERBOSE_OPTION_SHORT = "v", //
      VERBOSE_DESCRIPTION = "Show more progress-information", //

      QUIET_OPTION = "quiet", QUIET_OPTION_SHORT = "q", //
      QUIET_DESCRIPTION = "Suppress any output.", //

      RESET_OPTION = "reset-db", RESET_OPTION_SHORT = "r", //
      RESET_DESCRIPTION = "Reset given database", //

      SHOW_OPTION = "show-dialog", SHOW_OPTION_SHORT = "s", //
  ...
  public CommandLineInterpreter parseArguments(String[] args) {
    ...
    for (String arg : args) {
      arg = arg.trim().replaceFirst("[-]+", "");
      if (arg.equals(HELP_OPTION_SHORT) || arg.equals(HELP_OPTION)) {
        ConsoleOutputFormatter.printCLIHelp();
      }
      if (arg.equals(HELP_EXTENDED_OPTION_SHORT) || arg.equals(HELP_EXTENDED_OPTION)) {
        ConsoleOutputFormatter.printCLIExtendedHelp();
      }
      if (arg.equals(GUI_OPTION_SHORT) || arg.equals(GUI_OPTION)) {
        this.gui = true;
      }
    }
    ...
    try {
      ...
      ConsoleOutputFormatter.printCLIHelp(e.getMessage());
    }
    return this;
  }
